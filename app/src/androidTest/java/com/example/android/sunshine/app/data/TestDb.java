...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        insertAndGetLocationRowId();
    }

    private long insertAndGetLocationRowId() {
        ...
        assertNotSame("Error: Failure to insert North Pole Location Values", locationRowId, -1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Values inserted in " +
                        WeatherContract.LocationEntry.TABLE_NAME + " not as expected",
                cursor, locationValues);

        assertFalse("Error: More than one record returned from location query", cursor.moveToNext());

//        TestUtilities.validateCursor("Values inserted in " +
//                        WeatherContract.LocationEntry.TABLE_NAME + " not as expected",
//                cursor, locationValues);
    ...
    public void testWeatherTable() {
        ...
        long locationRowId = insertAndGetLocationRowId();
        ...
        assertNotSame("Error: Failure to insert Weather Values", weatherRowId, -1);
        ...
        TestUtilities.validateCurrentRecord("Values inserted in " +
                        WeatherContract.WeatherEntry.TABLE_NAME + " not as expected",
